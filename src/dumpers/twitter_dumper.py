...
user_location= excluded.user_location, statuses_count= excluded.statuses_count;"""
    ...
    INSERT_ID_QUERY = "INSERT INTO tweets (id) VALUES %s ON CONFLICT(id) DO NOTHING"
    ...
    def _insert_ids(ids=List[Tuple[int]]):
        ...
        with Connection() as connection:
            ...
            extras.execute_values(cur, TweetDumper.INSERT_ID_QUERY, ids)
            connection.commit()
            cur.close()
...
if __name__ == '__main__':
    ...
    extracted_tweets = [{'id': 1192227287204290560,
                         ...
                         'hash_tags': [], 'top_left': None, 'bottom_right': None,
                        ...
                        {'id': 1192227271983214593,
                         ...
                         'hash_tags': [], 'top_left': [-94.406743, 32.491967],
